...
#
# Verificando se o usuário é Root, Distribuição é >=20.04 e o Kernel é >=5.4 <IF MELHORADO)
...
#
# Script de instalação do LAMP-Server no GNU/Linux Ubuntu Server 20.04.x
...
#
echo
echo -e "Instalação do LAMP-SERVER no GNU/Linux Ubuntu Server 20.04.x\n"
