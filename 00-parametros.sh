#!/bin/bash
# Data de atualização: 25/11/2022
# Versão: 0.1.0
# Testado e homologado para a versão do Ubuntu Server 20.04 LTS x64
# Kernel >= 5.4.x
#
...
OCSVERSION="2.11.1/OCSNG_UNIX_SERVER-2.11.1.tar.gz"
OCSTAR="OCSNG_UNIX_SERVER-2.11.1.tar.gz"
OCSINSTALL="OCSNG_UNIX_SERVER-2.11.1"
#
...
OCSAGENTVERSION="v2.10.0/Ocsinventory-Unix-Agent-2.10.0.tar.gz"
...
GLPIVERSION="10.0.5/glpi-10.0.5.tgz"
GLPITAR="glpi-10.0.5.tgz"
GLPIINSTALL="glpi"
#
...
GLPIOCSVERSION="2.0.4/glpi-ocsinventoryng-2.0.4.tar.bz2"
GLPIOCSTAR="glpi-ocsinventoryng-2.0.4.tar.bz2"
...
# https://github.com/fusioninventory/fusioninventory-for-glpi/releases/download/glpi10.0.3%2B1.0/fusioninventory-10.0.3+1.0.tar.bz2
GLPIFISVERSION="glpi10.0.3%2B1.0/fusioninventory-10.0.3+1.0.tar.bz2"
GLPIFISTAR="fusioninventory-10.0.3+1.0.tar.bz2"
...
# 'ocs'@'localhost' usuário de administração do banco de dados do OCS Inventory | PASSWORD('!@#Admin#@!') nova senha 
...
SETOCSPWD="SET PASSWORD FOR 'ocs'@'localhost' = PASSWORD('!@#Admin#@!');"
...
#              https://github.com/OCSInventory-NG/WindowsAgent/releases/download/2.10.0.0/OCS-Windows-Agent-2.10.0.0_x64.zip
OCSAGENTWIN10="https://github.com/OCSInventory-NG/WindowsAgent/releases/download/2.10.0.0/OCS-Windows-Agent-2.10.0.0_x64.zip"
OCSAGENTWINXP="https://github.com/OCSInventory-NG/WindowsAgent/releases/download/2.1.1.1/OCSNG-Windows-Agent-2.1.1.zip"
OCSAGENTMAC="https://github.com/OCSInventory-NG/UnixAgent/releases/download/v2.10.0/Ocsinventory_Unix_Agent-2.10.0-MAC.tar.gz"
